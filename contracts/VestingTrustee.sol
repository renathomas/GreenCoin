...
contract VestingTrustee is Ownable {
    ...
    /// @dev Constructor that initializes the address of the GreenCoin contract.
    /// @param _greenCoin The address of the previously deployed GreenCoin smart contract.
    constructor(GreenCoin _greenCoin) public {
        require(_greenCoin != address(0));

        greenCoin = _greenCoin;
    }
    ...
    function grant(address _to, uint256 _value, uint256 _start, uint256 _cliff, uint256 _end, bool _revokable)
        ...
        require(totalVesting.add(_value) <= greenCoin.balanceOf(address(this)));
    ...
    function unlockVestedTokens() public {
        ...
        greenCoin.transfer(msg.sender, transferable);
